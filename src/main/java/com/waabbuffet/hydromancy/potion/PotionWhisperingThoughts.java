...
public class PotionWhisperingThoughts extends Potion{

	private final ResourceLocation iconTexture;

	public PotionWhisperingThoughts(boolean isBadEffect, int liquidColor, String name) {
	...
	public PotionWhisperingThoughts(boolean isBadEffect, int liquidR, int liquidG, int liquidB, String name) {
