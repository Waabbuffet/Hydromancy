...
public class TranslationTableResearch extends GuiButton{
	...
	//Gui's normal horizontal/vertical draw doesn't support doubles
	private static void drawRect(double p_73734_0_, double p_73734_1_, double p_73734_2_, double p_73734_3_, int[] p_73734_4_)
    {
        ...
        vb.pos((double)p_73734_0_, (double)p_73734_3_, 0.0D);
        vb.pos((double)p_73734_2_, (double)p_73734_3_, 0.0D);
        vb.pos((double)p_73734_2_, (double)p_73734_1_, 0.0D);
        vb.pos((double)p_73734_0_, (double)p_73734_1_, 0.0D);
        tessellator.draw();
        GL11.glEnable(GL11.GL_TEXTURE_2D);
        GL11.glDisable(GL11.GL_BLEND);
    }
