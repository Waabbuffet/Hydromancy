...
public class GuiButtonArrowDown extends GuiButton{
	...
	public void drawAButton(Minecraft mc, int mx, int my)
	{
		...
		if(!hovering)
			drawTexturedModalRect(xPosition, yPosition, 129, 233, 9, 8);
		else
			drawTexturedModalRect(xPosition, yPosition, 147, 233, 9, 8);
	}
}
