...
import com.waabbuffet.hydromancy.inventory.containers.SlotTranslationTable;
...
public abstract class GuiContainerVisibility extends GuiScreen
{
    ...
    public GuiContainerVisibility(Container inventorySlotsIn)
    {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(slotVisibility)
        {
	        ...
	        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
	        {
	            ...
	            if(slot instanceof SlotResearchNote)
	            	if(!((SlotResearchNote)slot).visible)
	            		continue;
