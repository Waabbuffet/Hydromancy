...
public class GuiTranslatedPage extends GuiScreen
{
	...
	public void initGui()
	{
		if(pageEntry == null && !player.getHeldItem().stackTagCompound.getString("research").contentEquals("scribble")){
			pageEntry = TranslationTableUtils.getPageBasedOnResearchName(player.getHeldItem().stackTagCompound.getString("research")).getLexiconPage();
		}
	}
