...
public class Reference 
{
	...
	public static class LexiconData
	{
		public static final String Purifier_Page_1_Text = 
				...
				+ "                     What if we wrapped a furnace with some coral and iron?";
		
		public static final String Purifier_Page_2_Text = "This purifier, however, is not perfect. You have found "
